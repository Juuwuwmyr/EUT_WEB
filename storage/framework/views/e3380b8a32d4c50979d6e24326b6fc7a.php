        ...
        <div class="hero-avatar-row">
            <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->user()->avatar): ?>
                    <img src="<?php echo e(auth()->user()->avatar); ?>" alt="Avatar" class="hero-avatar">
                <?php else: ?>
                    <div class="hero-avatar-placeholder"><?php echo e(strtoupper(substr(auth()->user()->name,0,1))); ?></div>
                <?php endif; ?>
                <div>
                    <p class="hero-greeting">Welcome back</p>
                    <p class="hero-name"><?php echo e(auth()->user()->name); ?></p>
                    <p class="hero-email"><?php echo e(auth()->user()->email); ?></p>
                </div>
            <?php else: ?>
...
<div class="page-body">
    ...
    <div class="section-card" style="margin-bottom:20px;">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('home')); ?>" class="menu-row">
            <div class="menu-icon" style="background:rgba(250,204,21,0.1);">
...
<nav class="bottom-nav">
    <div class="bottom-nav-inner">
        ...
        <a href="<?php echo e(route('shop.profile')); ?>" class="bnav-item active">
...
<?php /**PATH C:\Users\patri\Desktop\EUT_WEB\resources\views/shop/profile.blade.php ENDPATH**/ ?>