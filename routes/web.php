...
// Alias: QR codes point to /checkout?table=N — redirect to the real route preserving query string
Route::get('/checkout', fn() => redirect('/shop/checkout?' . request()->getQueryString()));
