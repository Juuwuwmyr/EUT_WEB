...
Route::prefix('chef')->name('chef.')->middleware(['auth', 'chef'])->group(function () {
    ...
    Route::get('/orders/table-bill/{table}',            [\App\Http\Controllers\ChefController::class, 'tableReceiptByNumber'])->name('orders.table-bill');
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/audit-logs/poll', [AdminController::class, 'auditLogsPoll'])->name('audit-logs.poll');
});
