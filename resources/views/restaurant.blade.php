...
<div id="maint-screen">
    ...
    <div class="m-timer" id="maint-timer-rest">5:00</div>
    <p class="m-note" id="maint-note-rest">This page refreshes automatically.</p>
</div>
<script>
(function(){
    var end=Date.now()+5*60*1000;
    function fmt(ms){var s=Math.max(0,Math.ceil(ms/1000));return Math.floor(s/60)+':'+(('0'+(s%60)).slice(-2));}
    var timer=document.getElementById('maint-timer-rest');
    var note=document.getElementById('maint-note-rest');
