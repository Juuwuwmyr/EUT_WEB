...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Burgers ──────────────────────────────────────────
        $burgerItems = [
            ['name'=>'EUT Classic Burger',    'description'=>'Juicy beef patty, lettuce, tomato, pickles, special sauce on brioche bun','price'=>350,'image'=>'/images/hero-burger.webp',              'featured'=>true,  'sort_order'=>1],
            ['name'=>'Gourmet Cheeseburger',  'description'=>'Premium beef with aged cheddar, caramelized onions, bacon',               'price'=>420,'image'=>'/images/gourmet-burger.webp',          'featured'=>true,  'sort_order'=>2],
            ['name'=>'Spicy Jalapeño Burger', 'description'=>'Flame-grilled patty with jalapeños, pepper jack cheese, chipotle mayo',   'price'=>380,'image'=>'/images/delicious-burger-fries.webp',  'featured'=>false, 'sort_order'=>3],
            ['name'=>'Mushroom Swiss Burger', 'description'=>'Sautéed mushrooms, Swiss cheese, garlic aioli on artisan bread',          'price'=>395,'image'=>'/images/combo-meal.webp',              'featured'=>false, 'sort_order'=>4],
            ['name'=>'BBQ Bacon Burger',      'description'=>'Smoky BBQ sauce, crispy bacon, onion rings, cheddar cheese',              'price'=>410,'image'=>'/images/hero-burger.webp',              'featured'=>false, 'sort_order'=>5],
            ['name'=>'Veggie Delight Burger', 'description'=>'House-made veggie patty with avocado, sprouts, herbed mayo',              'price'=>320,'image'=>'/images/gourmet-burger.webp',          'featured'=>false, 'sort_order'=>6],
        ];
        ...
        // ── Sides ────────────────────────────────────────────
        $sideItems = [
            ['name'=>'Classic French Fries',  'description'=>'Golden crispy fries with sea salt',                           'price'=>120,'image'=>'/images/french-fries.webp',   'featured'=>true,  'sort_order'=>1],
            ['name'=>'Sweet Potato Fries',    'description'=>'Crispy sweet potato fries with honey mustard dip',             'price'=>150,'image'=>'/images/fries-cutout.webp',   'featured'=>false, 'sort_order'=>2],
            ['name'=>'Onion Rings',           'description'=>'Beer-battered onion rings with ranch dip',                     'price'=>135,'image'=>'/images/french-fries.webp',   'featured'=>false, 'sort_order'=>3],
            ['name'=>'Loaded Nachos',         'description'=>'Tortilla chips with cheese sauce, jalapeños, sour cream',      'price'=>195,'image'=>'/images/single-fries.webp',   'featured'=>true,  'sort_order'=>4],
            ['name'=>'Coleslaw',              'description'=>'Creamy house coleslaw with a tangy finish',                    'price'=>80, 'image'=>'/images/fries-cutout.webp',   'featured'=>false, 'sort_order'=>5],
        ];
        ...
        // ── Beverages ─────────────────────────────────────────
        $bevItems = [
            ['name'=>'Classic Iced Tea',      'description'=>'Freshly brewed iced tea with lemon',                           'price'=>80, 'image'=>'/images/restaurant-interior.webp','featured'=>true,  'sort_order'=>1],
            ['name'=>'Mango Smoothie',        'description'=>'Fresh mango blended with yogurt and honey',                    'price'=>150,'image'=>'/images/restaurant-interior.webp','featured'=>true,  'sort_order'=>2],
            ['name'=>'Americano',             'description'=>'Double espresso with hot water, rich and bold',                'price'=>120,'image'=>'/images/restaurant-interior.webp','featured'=>false, 'sort_order'=>3],
            ['name'=>'Strawberry Lemonade',   'description'=>'Fresh strawberries blended with tangy lemonade',               'price'=>130,'image'=>'/images/restaurant-interior.webp','featured'=>false, 'sort_order'=>4],
        ];
        ...
        // ── Combo Meals ───────────────────────────────────────
        $comboItems = [
            ['name'=>'EUT Classic Combo',     'description'=>'Classic Burger + Classic Fries + Iced Tea',                    'price'=>550,'image'=>'/images/combo-meal.webp',       'featured'=>true,  'sort_order'=>1],
            ['name'=>'Gourmet Combo',         'description'=>'Gourmet Cheeseburger + Sweet Potato Fries + Americano',        'price'=>650,'image'=>'/images/combo-meal.webp',       'featured'=>true,  'sort_order'=>2],
            ['name'=>'Spicy Combo',           'description'=>'Spicy Jalapeño Burger + Onion Rings + Lemonade',               'price'=>740,'image'=>'/images/combo-meal.webp',       'featured'=>false, 'sort_order'=>3],
        ];
